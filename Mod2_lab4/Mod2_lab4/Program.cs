...
namespace Mod2_lab4
{
    class Program
    {
        static void Main(string[] args)
        {
            // Create a while loop
            // We start wuth n = 1
            // The condition check for the while, tests if n is than 6, if so, the loop body code executes
            ...
            // which is due to the condition not being checked untill the end.
            // Experiment with this by setting x to a value greater than 5 and run this code
